<div>
    ...
    <form wire:submit.prevent="crearProyecto" novalidate>
        <div class="mb-6">
        ...
        <div class="mb-6">
            ...
            <input type="file" accept="image/*" id="imagen"
                class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light"
                required wire:model.defer="imagen">
        ...
        <div class="mb-6">
            ...
            <div class="grid grid-cols-2 md:grid md:grid-cols-5 md:gap-3 mb-4 gap-5 ">
                @forelse ($tecnologias as $tecnologia)
                    <div>
                        <input id="tecnologia" type="checkbox" wire:model.defer="tecnologia" value="{{ $tecnologia->id }}"
        ...
        <div class="mb-6">
            ...
            <textarea id="descripcion" rows="4"
                ...
                placeholder="Di algo sobre el proyecto..." wire:model="descripcion">
